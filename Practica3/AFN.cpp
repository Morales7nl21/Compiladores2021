...
vector<vector<string>> AFN::getTransiciones(){return nuevas_transiciones;};
vector<string> AFN::getEstadosFinales(){ return estadosFinalesAFD;};
string AFN::getEdoInicial(){return edoInicial;};
vector<string> AFN::getAlfabeto(){return alfabeto;};
vector<string> AFN::getEstados(){return estadosNuevos;};